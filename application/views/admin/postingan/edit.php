            ...
            <form action="<?php echo site_url('anggota/updatepostingan') ?>" method="post" enctype="multipart/form-data">
              <?php foreach ($postingan as $p) : ?>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nama Postingan</label>
                    <input type="text" name="nama" class="form-control" id="nama" placeholder="Nama Postingan" value="<?= $p->nama ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Keterangan</label>
                    <textarea class="form-control" name="keterangan" id="keterangan" rows="5" placeholder="Keterangan"><?php echo $p->keterangan ?></textarea>
                  </div>
